...
\def\TournamentSubtitle{Preliminary Schedule}
\def\Phase{Preliminary Rounds (1--5)}
\def\ControlRoom{Library}
...
\Seed(02)={Cistercian A}
\Seed(03)={Caddo Magnet B}
\Seed(04)={Cistercian B}
\Seed(05)={Flower Mound}
\Seed(06)={Bolton}
\Seed(07)={Loyola A}
\Seed(08)={Caddo Magnet C}
\Seed(09)={Leesville}
\Seed(10)={Neville B}
\Seed(11)={North Desoto A}
\Seed(12)={North Desoto B}
\Seed(13)={Neville A}
\Seed(14)={North Caddo}
\Seed(15)={North Desoto C}
\Seed(16)={Loyola B}
\Seed(17)={C. E. Byrd}
\Seed(18)={}
...
\newarray\PoolARoom
\PoolARoom(1)={Room A2 (Bye)} % Average difference between seeds: 9.2
\PoolARoom(2)={Room A6} % Average difference between seeds: 6.0
\PoolARoom(3)={Room A7} % Average difference between seeds: 7.0
\newarray\PoolBRoom
\PoolBRoom(1)={Room A8} % Average difference between seeds: 8.4
\PoolBRoom(2)={Room A10} % Average difference between seeds: 6.0
\PoolBRoom(3)={Room A11} % Average difference between seeds: 6.6
\newarray\PoolCRoom
\PoolCRoom(1)={Room A12} % Average difference between seeds: 7.6
\PoolCRoom(2)={Room A14} % Average difference between seeds: 6.0
\PoolCRoom(3)={Room A16} % Average difference between seeds: 6.2
...
\begin{document}
    \begin{center}
        ...
        \begin{tabular}{|y{\LeftColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}|}
            ...
            \round{\Round(2)}		&	\matchup{\Seed(18)}{\Seed(01)}	&	\matchup{\Seed(06)}{\Seed(13)}	&	\matchup{\Seed(12)}{\Seed(07)}			\tabularnewline
            \round{\Round(3)}		&	\matchup{\Seed(18)}{\Seed(13)}	&	\matchup{\Seed(07)}{\Seed(01)}	&	\matchup{\Seed(06)}{\Seed(12)}			\tabularnewline
            \round{\Round(4)}		&	\matchup{\Seed(18)}{\Seed(12)}	&	\matchup{\Seed(01)}{\Seed(13)}	&	\matchup{\Seed(06)}{\Seed(07)}			\tabularnewline
            \round{\Round(5)}		&	\matchup{\Seed(18)}{\Seed(07)}	&	\matchup{\Seed(01)}{\Seed(06)}	&	\matchup{\Seed(12)}{\Seed(13)}			\tabularnewline
            \hline
        \end{tabular}
