...
\newarray\Seed
\Seed(01)={Caddo Magnet A}
\Seed(02)={E. D. White Catholic}
\Seed(03)={LSU Lab}
\Seed(04)={University View}
\Seed(05)={New Orleans Sacred Heart}
\Seed(06)={Zachary A}
\Seed(07)={Dutchtown}
\Seed(08)={Jesuit}
\Seed(09)={Southside A}
\Seed(10)={Baton Rouge Episcopal A}
\Seed(11)={St. Martin's Episcopal}
\Seed(12)={Baton Rouge Episcopal B}
\Seed(13)={Southside B}
\Seed(14)={Zachary B}
\Seed(15)={Caddo Magnet B}
...
\PoolARoom(3)={Bye} % Average difference between seeds: 7.0
\newarray\PoolBRoom
\PoolBRoom(1)={Room 3} % Average difference between seeds: 8.4
\PoolBRoom(2)={Room 4} % Average difference between seeds: 6.0
\PoolBRoom(3)={Room 5} % Average difference between seeds: 6.6
\newarray\PoolCRoom
\PoolCRoom(1)={Room 6} % Average difference between seeds: 7.6
\PoolCRoom(2)={Room 7} % Average difference between seeds: 6.0
\PoolCRoom(3)={Room 5} % Average difference between seeds: 6.2
...
\begin{document}
    \begin{center}
        ...
        \begin{tabular}{|y{\LeftColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}|}
            ...
            \hline
            \round{\Round(1)}		&	\matchup{\Seed(01)}{\Seed(12)}	&	\matchup{\Seed(13)}{\Seed(07)}	&	\bye{\Seed(06)}			\tabularnewline
            \round{\Round(2)}		&	\matchup{\Seed(12)}{\Seed(07)}	&	\matchup{\Seed(06)}{\Seed(13)}	&	\bye{\Seed(01)}			\tabularnewline
            \round{\Round(3)}		&	\matchup{\Seed(06)}{\Seed(12)}	&	\matchup{\Seed(07)}{\Seed(01)}	&	\bye{\Seed(13)}			\tabularnewline
            \round{\Round(4)}		&	\matchup{\Seed(01)}{\Seed(13)}	&	\matchup{\Seed(06)}{\Seed(07)}	&	\bye{\Seed(12)}			\tabularnewline
            \round{\Round(5)}		&	\matchup{\Seed(12)}{\Seed(13)}	&	\matchup{\Seed(01)}{\Seed(06)}	&	\bye{\Seed(07)}			\tabularnewline
            \hline
        \end{tabular}
        ...
        \begin{tabular}{|y{\LeftColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}|}
            ...
            \hline
            \round{\Round(1)}		&	\matchup{\Seed(02)}{\Seed(11)}	&	\matchup{\Seed(14)}{\Seed(08)}	&	\bye{\Seed(05)}	\tabularnewline
            \round{\Round(2)}		&	\matchup{\Seed(11)}{\Seed(08)}	&	\matchup{\Seed(05)}{\Seed(14)}	&	\bye{\Seed(02)}	\tabularnewline
            \round{\Round(3)}		&	\matchup{\Seed(05)}{\Seed(11)}	&	\matchup{\Seed(08)}{\Seed(02)}	&	\bye{\Seed(14)}	\tabularnewline
            \round{\Round(4)}		&	\matchup{\Seed(02)}{\Seed(14)}	&	\matchup{\Seed(05)}{\Seed(08)}	&	\bye{\Seed(11)}	\tabularnewline
            \round{\Round(5)}		&	\matchup{\Seed(11)}{\Seed(14)}	&	\matchup{\Seed(02)}{\Seed(05)}	&	\bye{\Seed(08)}	\tabularnewline
            \hline
        \end{tabular}
        ...
        \begin{tabular}{|y{\LeftColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}x{\RoomColumnWidth}|}
            ...
            \hline
            \round{\Round(1)}		&	\matchup{\Seed(03)}{\Seed(10)}	&	\matchup{\Seed(15)}{\Seed(09)}	&	\bye{\Seed(04)}	\tabularnewline
            \round{\Round(2)}		&	\matchup{\Seed(10)}{\Seed(09)}	&	\matchup{\Seed(04)}{\Seed(15)}	&	\bye{\Seed(03)}	\tabularnewline
            \round{\Round(3)}		&	\matchup{\Seed(04)}{\Seed(10)}	&	\matchup{\Seed(09)}{\Seed(03)}	&	\bye{\Seed(15)}	\tabularnewline
            \round{\Round(4)}		&	\matchup{\Seed(03)}{\Seed(15)}	&	\matchup{\Seed(04)}{\Seed(09)}	&	\bye{\Seed(10)}	\tabularnewline
            \round{\Round(5)}		&	\matchup{\Seed(10)}{\Seed(15)}	&	\matchup{\Seed(03)}{\Seed(04)}	&	\bye{\Seed(09)}	\tabularnewline
            \hline
        \end{tabular}
    \end{center}
